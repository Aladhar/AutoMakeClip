...
class AnalysisConfig:
    ...
    enable_sustained_multikill_candidates: bool = False
    sustained_candidate_window_seconds: float = 10.0
    sustained_candidate_min_duration_seconds: float = 4.2
    sustained_candidate_max_duration_seconds: float = 12.0
    sustained_candidate_spacing_seconds: float = 10.0
    sustained_candidate_min_peak_count: int = 2
    sustained_candidate_min_gameplay_percentile: float = 55.0
    sustained_candidate_min_average_audio: float = 0.12
    sustained_candidate_min_average_center: float = 0.26
    sustained_candidate_min_average_killfeed: float = 0.18
    sustained_candidate_min_burst_events: int = 2
    sustained_candidate_peak_threshold_percentile: float = 70.0
